      ...
      {foliosData.map((folio, index) => {
        ...
        return (
          ...
          >
            ...
            <div className="absolute right-full mr-2.5 top-1/2 -translate-y-1/2 px-2.5 py-1 bg-[#111111] text-[#fbfbfa] text-[10px] font-mono whitespace-nowrap rounded-xs shadow-xl opacity-0 pointer-events-none group-hover:opacity-100 transition-all duration-150 z-50 flex items-center">
