      ...
      <footer className="flex-shrink-0 mt-2 sm:mt-3 pt-2.5 sm:pt-3 border-t border-[#d5d5cd] flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 font-mono text-xs select-none">
        ...
        <div className="flex items-center gap-2 text-center sm:text-right">
          <a
            ...
            className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-xs border border-[#d5d5cd] bg-[#ebebe3] hover:bg-[#111111] hover:text-[#fbfbfa] text-xs font-bold text-[#111111] transition-colors cursor-pointer"
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xs bg-[#111111] hover:bg-[#c23b22] text-[#fbfbfa] text-xs font-bold transition-colors cursor-pointer shadow-xs"
